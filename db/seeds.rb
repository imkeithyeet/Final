...
u2 = User.create(first_name:"Keith",last_name:"Ma", email: 'yeser@gmail.com', password: "yam123", gender: "Male", age:"26", occupation: "Student",location: "Los Angeles California", bio: "A down to earth guy that doesn't give into other people's thoughts.", horoscope: "Gemini")
